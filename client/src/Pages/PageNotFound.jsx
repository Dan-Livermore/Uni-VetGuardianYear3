...
const PageNotFound = () => {
  return (
    <div className="flex justify-center items-center flex-col min-h-screen-1 pt-6 pb-6 bg-purple-100 font-sans">
      ...
      <Link to="/">
        <button type="submit" className="bg-purple-500 hover:bg-purple-700 text-white font-bold text-2xl py-2 px-4 rounded-md mt-2">Return Home</button>
      </Link>
    </div>
  );
};
