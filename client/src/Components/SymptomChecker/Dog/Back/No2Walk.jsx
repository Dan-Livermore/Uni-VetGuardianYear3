...
import Yes3Move from './Yes3Move';
import No3Move from './No3Move';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Does the difficulty seem to improve after movement?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes3Move selected={selectedButton} />
                ) : (
                  <No3Move selected={selectedButton} />
                ))}
            </div>
            </>
          )}
