...
import Yes1Scratching from './Yes1Scratching';
import No1Scratching from './No1Scratching';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Is your dog scratching at its ears?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes1Scratching selected={selectedButton} />
                ) : (
                  <No1Scratching selected={selectedButton} />
                ))}
            </div>
            </>
          )}
