...
import Yes4Balance from './Yes4Balance';
import No4Balance from './No4Balance';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Is there a change in the pets hearing or balance?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes4Balance selected={selectedButton} />
                ) : (
                  <No4Balance selected={selectedButton} />
                ))}
            </div>
            </>
          )}
