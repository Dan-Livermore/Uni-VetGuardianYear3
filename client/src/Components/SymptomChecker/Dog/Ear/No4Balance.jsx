...
import Yes7Chewing from './Yes7Chewing';
import No7Chewing from './No7Chewing';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Are there signs of pain when opening the mouth or chewing?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes7Chewing selected={selectedButton} />
                ) : (
                  <No7Chewing selected={selectedButton} />
                ))}
            </div>
            </>
          )}
