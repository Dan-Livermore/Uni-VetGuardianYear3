...
import Yes1Swollen from './Yes1Swollen';
import No1Swollen from './No1Swollen';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Is there a swelling on the area?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes1Swollen selected={selectedButton} />
                ) : (
                  <No1Swollen selected={selectedButton} />
                ))}
            </div>
            </>
          )}
