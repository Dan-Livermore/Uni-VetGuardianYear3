...
import Yes7Bad from './Yes7Bad';
import No7Bad from './No7Bad';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Is there signs of diarrhea?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes7Bad selected={selectedButton} />
                ) : (
                  <No7Bad selected={selectedButton} />
                ))}
            </div>
            </>
          )}
