...
import Yes5Eating from './Yes5Eating';
import No5Eating from './No6Diah';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Has your dog changed its eating habits?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes5Eating selected={selectedButton} />
                ) : (
                  <No5Eating selected={selectedButton} />
                ))}
            </div>
            </>
          )}
