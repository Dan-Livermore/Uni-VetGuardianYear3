...
import Yes3Thick from './Yes3Thick';
import No3Thick from './No3Thick';
...
const No2Clear = () => {
    ...
    return (
        <>
          ...
          <p className="text-center">Is the discharge thick, colored, or accompanied by sneezing?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes3Thick selected={selectedButton} />
                ) : (
                  <No3Thick selected={selectedButton} />
                ))}
            </div>
            </>
          )}
