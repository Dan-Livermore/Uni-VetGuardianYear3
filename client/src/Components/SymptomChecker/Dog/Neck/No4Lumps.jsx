...
import Yes5Appetite from './Yes5Appetite';
import No5Appetite from './No5Appetite';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Has there been a decrease in appetite or a change in behavior?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes5Appetite selected={selectedButton} />
                ) : (
                  <No5Appetite selected={selectedButton} />
                ))}
            </div>
            </>
          )}
