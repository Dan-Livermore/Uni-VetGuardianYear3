...
import Yes2Crying from './Yes2Crying';
import No2Crying from './No2Crying';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Does the dog show signs of severe pain or cry out when moving?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes2Crying selected={selectedButton} />
                ) : (
                  <No2Crying selected={selectedButton} />
                ))}
            </div>
            </>
          )}
