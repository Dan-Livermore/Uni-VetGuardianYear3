...
import Yes1Limp from './Yes1Limp';
import No1Limp from './No1Limp';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Is the tail limp or not wagging?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes1Limp selected={selectedButton} />
                ) : (
                  <No1Limp selected={selectedButton} />
                ))}
            </div>
            </>
          )}
