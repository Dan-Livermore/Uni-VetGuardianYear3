...
import Yes10 from './Yes10';
import No10 from './No10';
...
const No9 = () => {
    ...
    return (
        <>
          ...
          <p className="text-center">Does the dog seem to experience pain during colder weather or after certain activities?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes10 selected={selectedButton} />
                ) : (
                  <No10 selected={selectedButton} />
                ))}
            </div>
            </>
          )}
