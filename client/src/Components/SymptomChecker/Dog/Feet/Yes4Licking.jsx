...
import Yes5Redness from './Yes5Redness';
import No5Redness from './No5Redness';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Are there signs of redness, swelling, or sores?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes5Redness selected={selectedButton} />
                ) : (
                  <No5Redness selected={selectedButton} />
                ))}
            </div>
            </>
          )}
