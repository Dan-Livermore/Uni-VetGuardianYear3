...
import Yes6Pads from './Yes6Pads';
import No6Pads from './No6Pads';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Are there cracked pads or growths?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes6Pads selected={selectedButton} />
                ) : (
                  <No6Pads selected={selectedButton} />
                ))}
            </div>
            </>
          )}
