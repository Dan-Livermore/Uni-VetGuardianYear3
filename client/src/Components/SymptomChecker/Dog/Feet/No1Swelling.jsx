...
import Yes4Licking from './Yes4Licking';
import No4Licking from './No4Licking';
    ...
    return (
      <>
        <div className="flex flex-col items-center py-4 dark:text-gray-300">
          <p className="text-center">Is your pet excessively licking / chewing on their paws?</p>
          ...
          <p className="text-sm pt-2 text-center">Selected: {selectedButton}</p>
            <div className="flex justify-center py-4 pb-4">
              {showElement &&
                (selectedButton === "Yes" ? (
                  <Yes4Licking selected={selectedButton} />
                ) : (
                  <No4Licking selected={selectedButton} />
                ))}
            </div>
            </>
          )}
